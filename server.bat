...
@rem Execute server
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %SERVER_OPTS% -Dprocess.profile=dev -DCONFIG_PATH=config/auto -DAPP_PRO_PATH=config -classpath "%CLASSPATH%" com.zhangyx.vmail.Application %CMD_LINE_ARGS%
