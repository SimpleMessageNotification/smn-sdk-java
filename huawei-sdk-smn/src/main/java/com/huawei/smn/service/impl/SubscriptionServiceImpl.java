...
public class SubscriptionServiceImpl implements SubscriptionService {
	 ...
	 */
	@Override
	public Map<String, Object> subscribe(SmnRequest smnRequest) throws RuntimeException {
	 ...
	 */
	@Override
	public Map<String, Object> unsubscribe(SmnRequest smnRequest) throws RuntimeException {
		long startTime = System.currentTimeMillis();
		try {
			init();
			String url = smnRequest.getRequestUrl();
	 ...
	 */
	@Override
	public Map<String, Object> listSubscriptions(SmnRequest smnRequest) throws RuntimeException {
		long startTime = System.currentTimeMillis();
		try {
			init();
			String url = smnRequest.getRequestUrl();
	 ...
	 */
	@Override
	public Map<String, Object> listSubscriptionsByTopic(SmnRequest smnRequest) throws RuntimeException {
		long startTime = System.currentTimeMillis();
		try {
			init();
			String url = smnRequest.getRequestUrl();
