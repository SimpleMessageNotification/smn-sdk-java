...
public class UpdateTopicRequestTest extends TestCase {
	...
	public void testGetRequestUrl() throws Exception {
		...
		when(updateTopicRequest.getAuthenticationBean()).thenReturn(authenticationBean);
		...
		when(updateTopicRequest.getRequestUrl()).thenCallRealMethod();
		...
		Assert.assertEquals(requestURL, updateTopicRequest.getRequestUrl());
	}
